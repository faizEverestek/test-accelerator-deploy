...
from com.fineos.idam.petinsurance.commons.test_data_generator import TestDataGenerator

from com.fineos.idam.petinsurance.razorpay.dto.pet import Pet  # noqa: E501
...
class TestPet(unittest.TestCase):
    ...
    def setUp(self):
        self.data = TestDataGenerator.generate_sample_data(Pet)
        self.instance = Pet(**self.data)
    ...
    def test_valid_data(self):
        ...
        valid_data = TestDataGenerator.generate_sample_data(Pet)
        instance = Pet(**valid_data)
    ...
    def test_from_dict_with_none(self):
        ...
        self.assertIsNone(Pet.from_dict(None))
    
    def test_from_dict_with_invalid_type(self):
        """Test from_dict with non-dict input"""
        with self.assertRaises(ValidationError):
            Pet.from_dict("invalid")
    
    def test_invalid_data(self):
        """Test validation errors on invalid data"""
        invalid_data = TestDataGenerator.generate_invalid_data(Pet)
        with self.assertRaises(ValidationError):
            Pet(**invalid_data)
       
    def test_to_str(self):
        """Test string representation"""
        obj = Pet.from_dict(self.data)  # Convert dict to object
