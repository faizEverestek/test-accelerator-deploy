...
/**
* The location where the API key should be added in the request.
* It can either be "header" or "query".
*/
  private final String location;

/**
* The name of the API key.
* This is the key that will be used in the header or query parameter.
*/
  private final String name;

/**
* The value of the API key.
* This is the value that will be associated with the key in the request.
*/
