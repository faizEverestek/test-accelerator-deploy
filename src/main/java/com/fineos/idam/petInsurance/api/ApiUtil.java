 ...
 * <p>
 * This class provides helper methods for handling API responses and includes
...
public final class ApiUtil {
    ...
    public static class ResponseProcessingException extends RuntimeException {
        ...
        /**
         * Constructs a new {@code ResponseProcessingException} with the specified
     ...
     *
     * @param req         The {@link NativeWebRequest} from which to obtain the
     ...
     *
     * @throws IllegalStateException       if the {@link HttpServletResponse} is
     *                                     null
     * @throws ResponseProcessingException if an {@link IOException} occurs while
