...
from com.fineos.idam.petinsurance.api.management_api_base import BaseManagementApi
import com.fineos.idam.petinsurance.impl
...
from com.fineos.idam.petinsurance.dto.extra_models import TokenModel  # noqa: F401


router = APIRouter()

ns_pkg = com.fineos.idam.petinsurance.impl
