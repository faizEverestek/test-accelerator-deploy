...
class PetsApiControllerTest {
     ...
     *
     * <ul>
     *   <li>Refer to the commented code inside the method body for a sample test structure.
     *   <li>Uncomment and adapt it to your controller logic and expected outcomes.
     *   <li>Update variable names, assertions, HTTP method, and URL accordingly.
     *   <li>Update this javadoc according to the test method description.
     * </ul>
     */
    @Test
    void test_createPets() throws Exception {
         ...
         * ////////////////////////////////////////////////////////////////////////
         *
         * // Verify status Assertions.assertEquals(201, response.getStatus(),
         * "HTTP status not matched");
         *
         * // Verify response headers Map<String, List<String>> headers =
         * response.getHeaderNames().stream() .collect(Collectors.toMap(h -> h, h ->
         * response.getHeaders(h))); Map<String, List<String>> expectedHeaders =
         * EmployeeTestHelper.getHeadersForTesting();
         * Assertions.assertEquals(expectedHeaders, headers);
         *
         * // Verify response body String responseContent =
         * response.getContentAsString(); Employee actual =
         * objectMapper.readValue(responseContent, Employee.class);
         * Assertions.assertEquals(employee, actual,
         * "Employee details do not match expected employee");
         */
    }
