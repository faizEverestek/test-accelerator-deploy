...
class PetTest {
    ...
    /**
     * Test for the getters and setters of the {@link Pet} class. This ensures that
     * the getters and setters are functioning correctly.
     */
    @Test
    ...
    /**
     * Test for the equals and hashCode methods of the {@link Pet} class. This test
     * verifies that the equals and hashCode methods work as expected for both equal
     * and non-equal objects.
     */
    @Test
    ...
    /**
     * Test for the toString method of the {@link Pet} class. This ensures that the
     * toString method returns the expected string representation.
     */
    @Test
    void testToString() {
    ...
    /**
     * Test for the validation constraints of the {@link Pet} class. This test
     ...
     *
     * <p>
     * This method initializes a {@link Pet} object with predefined values to be
     * used in unit tests.
     * </p>
     *
