...
/**
 * Test class for the OpenApiGeneratorApplication. It ensures that the Spring
...
class OpenApiGeneratorApplicationTests {
     ...
     * This is a basic sanity check to ensure the application configuration is
     * correct.
     */
    @Test
    void contextLoads() {
        Assertions.assertDoesNotThrow(() -> SpringApplication.run(OpenApiGeneratorApplication.class),
     ...
     * when the main method of {@link OpenApiGeneratorApplication} is executed.
     * <p>
     * It ensures that the necessary application profile setup is invoked before
     * {@code SpringApplication.run()} is executed.
     */
    @Test
    void testSetApplicationProfileCalled() {
        try (MockedStatic<SpringApplication> mockedSpringApplication = Mockito.mockStatic(SpringApplication.class);
                MockedStatic<OpenApiGeneratorApplication> mockedApplication = Mockito
                        .mockStatic(OpenApiGeneratorApplication.class, Mockito.CALLS_REAL_METHODS)) {
    ...
    /**
     * Test case for the configure method to ensure the application is configured
     * correctly.
     */
    @Test
    void testConfigure() {
