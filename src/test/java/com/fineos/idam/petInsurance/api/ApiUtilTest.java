 ...
 *
 * <p>
 * This test class verifies the functionality of the {@code setExampleResponse}
 * method from the {@link ApiUtil} utility class. It ensures that the method
 * behaves as expected under various conditions, including normal execution,
 * null response scenarios, and cases where an I/O exception occurs.
 *
 * <p>
 * Mock objects and {@link Mockito} framework are used to simulate the behavior
 * of {@link NativeWebRequest} and {@link HttpServletResponse}.
 */
...
class ApiUtilTest {
     ...
     *
     * <p>
     * This method initializes the mock {@link NativeWebRequest} and
     * {@link HttpServletResponse}, and prepares a {@link StringWriter} to capture
     * the response output.
     *
     * @throws IOException If an I/O error occurs while setting up the response
     *                     writer.
     */
    @BeforeEach
    ...
    /**
     * Tests that the {@code setExampleResponse} method correctly sets headers and
    ...
    void testSetExampleResponseSuccess() {
        ...
        Assertions.assertEquals(exampleResponse, responseWriter.toString(),
                "The response body does not match the expected example response.");
    }

    /**
     * Tests that an {@code IllegalStateException} is thrown when
     * {@link HttpServletResponse} is null.
     */
    @Test
    void testSetExampleResponseNullResponse() {
        ...
        Assertions.assertEquals("HttpServletResponse is null", exception.getMessage(),
                "The exception message does not match the expected message.");
    }

    /**
     * Tests that a {@code ResponseProcessingException} is thrown when an
     * {@link IOException} occurs.
     *
     * <p>
     * This test simulates an I/O error while writing to the response and verifies
     * that {@link ApiUtil.ResponseProcessingException} is thrown with the expected
     * message.
     */
    @Test
    void testSetExampleResponseIOException() throws IOException {
        ...
        Assertions.assertEquals("Error writing response", exception.getMessage(),
                "The exception message does not match the expected message.");
        ...
        Assertions.assertEquals("Test IO Exception", exception.getCause().getMessage(),
