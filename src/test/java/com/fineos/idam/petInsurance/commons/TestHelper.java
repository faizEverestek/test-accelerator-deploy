...
public class TestHelper {
    ...
    /**
     * Generates a map of HTTP headers commonly used in general API response
     * testing.
     *
     * @return a {@link Map} containing header names as keys and a list of their
     *         corresponding values. Includes headers such as X-Frame-Options,
     *         Cache-Control, X-Content-Type-Options, Pragma, Expires,
     *         X-XSS-Protection, and Content-Type.
     */
    ...
    /**
     * Generates a map of HTTP headers used specifically for DELETE operation
     * testing.
     *
     * @return a {@link Map} containing header names and corresponding values
     *         relevant to DELETE operation tests. It excludes the Content-Type
     *         header used in general testing.
     */
