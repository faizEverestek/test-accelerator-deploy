 ...
 *
 * <p>
 * This class tests the redirection behavior of the {@code HomeController}. It
 * verifies that requests to the root URL ("/") are correctly redirected to the
...
class HomeControllerTest {
     ...
     *
     * <p>
     * Initializes {@code MockMvc} with an instance of {@code HomeController} to
     * enable unit testing of controller methods without starting a full Spring
     * application.
     * </p>
     */
    @BeforeEach
    ...
    /**
     * Tests the redirection behavior of the {@code index} method in
     * {@link HomeController}.
     *
     * <p>
     * Ensures that a GET request to the root URL ("/") results in an HTTP 302
     * redirect to the Swagger UI documentation page ("swagger-ui.html").
     * </p>
     *
    ...
    void testIndexRedirectsToSwaggerUI() throws Exception {
        ...
        MockHttpServletResponse response = mockMvc.perform(MockMvcRequestBuilders.get("/"))
                ...
                .andExpect(MockMvcResultMatchers.redirectedUrl(expectedRedirectUrl)).andReturn().getResponse();
