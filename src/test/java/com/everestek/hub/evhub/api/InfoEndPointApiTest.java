...
class InfoEndPointApiTest {
    ...
    void testContributeSuccess() throws Exception {
        ...
        Assertions.assertEquals("evhub", info.get("serviceName"), "Expected service name does not match.");
        Assertions.assertEquals(
                "The evhub micro-service for EVERESTEK.",
