...
class PetsApiControllerTest {
     ...
     * It is automatically injected by Spring's dependency injection.
     */
    ...
    void test_createPets() throws Exception {
        ...
        // // Verify status
        // Assertions.assertEquals(501, response.getStatus(), "HTTP status not matched");
        ...
        //                         TreeMap::new
        //                 ));
        // Map<String, List<String>> expectedHeaders = TestHelper.getHeadersForTesting();
        ...
        // Assertions.assertEquals(request, actual, "Request details do not match expected request");
    }
